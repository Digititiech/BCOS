...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigationItems = [
    ...
    { name: 'Calendar Timeline', path: '/dashboard/resources/calendar', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { name: 'Operating Hours', path: '/dashboard/resources/hours', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    { name: 'Preparation Buffers', path: '/dashboard/resources/buffers', icon: 'M11.933 12.8a1 1 0 000-1.6L6.6 7.2A1 1 0 005 8v8a1 1 0 001.6.8l5.333-4zM19.933 12.8a1 1 0 000-1.6l-5.33-4A1 1 0 0013 8v8a1 1 0 001.6.8l5.333-4z' },
    { name: 'Blocked Dates', path: '/dashboard/resources/blocked', icon: 'M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636' },
